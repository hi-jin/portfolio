...
export default function ContentSection({ categories, allPostsData }: { categories: string[], allPostsData: any[] }) {
  return (
        ...
        <ul className="mb-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {categories.map((category) => (
            <li key={category} className="mb-2">
              <Link href={`/category/${category}`} className="text-blue-500 hover:underline block p-4 bg-gray-100 dark:bg-gray-800 rounded-lg transition-colors duration-200 hover:bg-gray-200 dark:hover:bg-gray-700">
